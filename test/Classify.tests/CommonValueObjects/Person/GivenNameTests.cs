namespace Classify.tests.CommonValueObjects.Person
{
    ...
    {
        private readonly string TestValue = "Jon";

        [Fact]
        public void Value_should_return_the_non_sensitive_value()
        {
            var valueObject = new GivenName(TestValue);
        ...
        {
            var json = JsonSerializer.Serialize(new GivenName(TestValue));
        ...
        {
            var json = JsonConvert.SerializeObject(new GivenName(TestValue));
        ...
        {
            var json = JsonConvert.SerializeObject(new GivenName(TestValue), new Classify.JsonSerialization.Newtonsoft.IncludeSensitiveJsonConverter());
