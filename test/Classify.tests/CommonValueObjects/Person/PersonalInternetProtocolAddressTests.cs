namespace Classify.tests.CommonValueObjects.Person
{
    ...
    {
        private readonly string TestValue = "10.0.0.1";

        [Fact]
        public void Value_should_return_the_non_sensitive_value()
        {
            var valueObject = new PersonalInternetProtocolAddress(TestValue);
        ...
        {
            var json = JsonSerializer.Serialize(new PersonalInternetProtocolAddress(TestValue));
        ...
        {
            var json = JsonConvert.SerializeObject(new PersonalInternetProtocolAddress(TestValue));
        ...
        {
            var json = JsonConvert.SerializeObject(new PersonalInternetProtocolAddress(TestValue), new Classify.JsonSerialization.Newtonsoft.IncludeSensitiveJsonConverter());
